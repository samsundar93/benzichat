...
(function () {
  ...
  app.config(function (ChartJsProvider) {
    ...
    ChartJsProvider.setOptions({
      colors: ['#97BBCD', '#8e0b21', '#F7464A', '#46BFBD', '#FDB45C', '#949FB1', '#4D5360']
    });
  ...
  app.controller('LineCtrl', ['$scope', function ($scope) {
	...
	app.controller('fryerBarCtrl', ['$scope', function ($scope) {
		$scope.options = { legend: { display: true }, 
		showAllTooltips: false
		};
		$scope.labels = ['Ignition Lockout /Heating Failure','Heating Failure /Pressure Switch Failure','Ambient Overheat','Overheat Stats','No Heater On R'];
		...
		$scope.data = [ 
		  ...
		  { // dark grey
			...
			borderColor: '#c8102e',
			pointBorderColor: '#8e0b21',
			pointHoverBorderColor: '#8e0b21'
		  }
		];
	  }]);
  app.controller('BarCtrl', ['$scope', function ($scope) {
	...
	$scope.width = 100;
    $scope.labels = ['E01.1','E01.1 .1','E01.2'];
    $scope.series = ['Error Count'];
    $scope.data = [ 
      [5, 4, 7]
    ];
...
app.controller('menuBarMonthCtrl', ['$scope', function ($scope) { 
  ...
  app.controller('PieCtrl', ['$scope', function ($scope) {
	$scope.colors = ['#fbd0d7', '#f7a1af', '#f47187', '#f0425f', '#ec1337', '#c8102e', '#a50d27', '#760a1c', '#470611'];
